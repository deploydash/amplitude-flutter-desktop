...
import 'desktop/desktop_direct.dart'
    if (dart.library.io) 'desktop/desktop_direct_io.dart'
    as desktop_direct;
...
class Amplitude {
  ...
  /// Sends one API call: directly to the in-process desktop backend on
  /// Linux/Windows, over the engine channel everywhere else. Arguments and
  /// results keep the 14-method channel shape either way.
  Future<dynamic> _invoke(String method, [dynamic arguments]) {
    return desktop_direct.invokeDesktopMethod(_channel, method, arguments);
  }

  /// Private method to initialize and return a `Future<bool>`
  Future<bool> _init() async {
    try {
      await _invoke('init', configuration.toMap());
  ...
  /// ```
  Future<void> track(BaseEvent event, [EventOptions? options]) async {
    if (options != null) {
      event.mergeEventOptions(options);
    }

    return await _invoke('track', {
  ...
  Future<void> groupIdentify(
    ...
    return await _invoke('groupIdentify', {
      'instanceName': configuration.instanceName,
      'event': event.toMap(),
    });
  }
  ...
  Future<String?> getUserId() async {
    return await _invoke('getUserId', {
      'instanceName': configuration.instanceName,
    });
  }
  ...
  Future<void> setUserId(String? userId) async {
    ...
    return await _invoke('setUserId', {
      'instanceName': configuration.instanceName,
  ...
  Future<String?> getDeviceId() async {
    return await _invoke('getDeviceId', {
      'instanceName': configuration.instanceName,
    });
  }
  ...
  Future<void> setDeviceId(String? deviceId) async {
    ...
    return await _invoke('setDeviceId', {
      'instanceName': configuration.instanceName,
      'properties': properties,
    });
  }
  ...
  Future<int?> getSessionId() async {
    return await _invoke('getSessionId', {
      'instanceName': configuration.instanceName,
    });
  }
  ...
  Future<void> setOptOut(bool enabled) async {
    ...
    return await _invoke('setOptOut', {
      'instanceName': configuration.instanceName,
      'properties': properties,
    });
  }
  ...
  Future<void> reset() async {
    return await _invoke('reset', {'instanceName': configuration.instanceName});
  }

  /// Flush events in storage.
  Future<void> flush() async {
    return await _invoke('flush', {'instanceName': configuration.instanceName});
  }
}
